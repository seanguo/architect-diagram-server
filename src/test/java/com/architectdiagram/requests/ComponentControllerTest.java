package com.architectdiagram.requests;
...
public class ComponentControllerTest {
    ...
    public static void setUpClass() {
        TestWatchman.watchman.registerClass(ComponentControllerTest.class);
    }

    @AfterClass
    public static void tearDownClass() {
        TestWatchman.watchman.createReport(ComponentControllerTest.class);
    }
